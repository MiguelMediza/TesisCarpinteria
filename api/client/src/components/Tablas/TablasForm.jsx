...
const TablasForm = () => {
  ...
  const validateInputs = () => {
    ...
    if (isNaN(inputs.espesor_mm) || Number(inputs.espesor_mm) <= 0) return "Ingresa un espesor válido.";
  ...
  return (
    <section className="relative flex items-center justify-center min-h-screen bg-neutral-50">
      ...
      <div className="relative z-10 w-full sm:max-w-md p-6 bg-white bg-opacity-80 rounded-lg shadow-md">
        <Link to="/tablas" className="block mb-6 text-2xl font-semibold text-neutral-800 text-center">
        ...
        <form className="space-y-4 md:space-y-6" onSubmit={handleSubmit} encType="multipart/form-data">
          ...
          <div>
            ...
            <select name="cepilladas" id="cepilladas" value={inputs.cepilladas} onChange={handleChange} className="w-full p-2 rounded border border-neutral-300 bg-neutral-100 text-neutral-900 focus:outline-none focus:ring-2 focus:ring-neutral-400">
              <option value="" disabled>Cepillada</option>
